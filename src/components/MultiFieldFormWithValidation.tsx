            ...
            <div className="flex max-w-sm mx-auto mt-8">
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        />
                            {errors?.name && (
                                <p className="text-custom-dark-red">{errors.name}</p>
                            )}
                    </div>
                    <div>
                        <input
                        ...
                        />
                        {errors?.email && (
                            <p className="text-custom-dark-red">{errors.email}</p>
                        )}
                    </div>
                    <div>
                        <textarea
                        ...
                        ></textarea>
                        {errors?.message && (
                            <p className="text-custom-dark-red">{errors.message}</p>
                        )}
                    </div>
                    <div className="flex gap-4">
                        ...
                        <button
                            type="button"
                            onClick={handleClear}
                            className="bg-gray-200 text-custom-cf-gray px-4 py-2 rounded">
                            Clear
                        </button>
                    </div>
