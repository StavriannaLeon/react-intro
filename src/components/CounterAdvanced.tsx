        ...
        <>
            <div className="space-y-4 text-2xl pt-12">
                ...
                <div className="text-center space-x-4">
                    ...
                    <CounterButton onClick={resetCount} label="Reset" disabled={state.count === 0} addClass="bg-custom-dark-red"/>
                </div>
            </div>
            <p className="text-center pt-8">Last action: <strong>{state.lastAction || "-"}</strong> at <strong>{state.time || "-"}</strong></p>
        </>
    )
}
